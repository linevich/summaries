  ...
  \put(0,0){%
    \parbox[b][\paperheight]{\paperwidth}{%
      ...
      \includegraphics[width=\paperwidth,height=\paperheight,%
        keepaspectratio]{images/border_default.png}%
      \vfill
}}}
...
\newcommand\BackgroundPicFirstPage{%
  \put(0,0){%
    \parbox[b][\paperheight]{\paperwidth}{%
      ...
      \centering
      \includegraphics[width=\paperwidth,height=\paperheight,%
        keepaspectratio]{images/border_firstpage.jpg}%
      \vfill
}}}

\newcommand\BorderFirstPage{
  \newgeometry{top=1cm, bottom=4.5cm, left=3cm, right=0.7cm, headheight=0cm, foot=0cm}
  \ClearShipoutPicture
  \AddToShipoutPicture*{\BackgroundPicFirstPage}
}

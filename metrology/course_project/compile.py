from python.base import print_to_file
from python.indirect_mesurment import *
from python.mertological_explorations import *

print_to_file(print_delta)
...
print_to_file(print_sensitivity_table)
print_to_file(print_delta_sum)
